...
$q_terbaru = mysqli_query($conn, "
    SELECT users.nama_lengkap, users.email, pendaftaran.id AS id_daftar, pendaftaran.jurusan_pilihan, pendaftaran.status_pendaftaran, pendaftaran.tanggal_daftar 
    FROM users 
...
<head>
    ...
    <title>Dashboard Admin - SPMB AdmitFlow</title>
...
<body class="bg-gray-100 font-sans text-slate-800 flex h-screen overflow-hidden">
        ...
        <main class="p-8 bg-gray-50 flex-1">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Pantau perkembangan pendaftaran mahasiswa baru.</p>
                </div>
                <span class="text-sm bg-white px-3 py-1 rounded border shadow-sm text-gray-600">
                    <i class='bx bxs-calendar'></i> <?php echo date('d F Y'); ?>
                </span>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                <div class="bg-white p-6 rounded-xl shadow-sm border-b-4 border-blue-500 flex items-center gap-4 hover:-translate-y-1 transition duration-300">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border-b-4 border-yellow-400 flex items-center gap-4 hover:-translate-y-1 transition duration-300">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border-b-4 border-green-500 flex items-center gap-4 hover:-translate-y-1 transition duration-300">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border-b-4 border-purple-500 flex items-center gap-4 hover:-translate-y-1 transition duration-300">
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-slate-800">4</h3> </div>
                </div>
            </div>

            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                    <h3 class="font-bold text-slate-700 flex items-center gap-2"><i class='bx bx-list-ul'></i> Pendaftaran Terbaru</h3>
                    <a href="verifikasi.php" class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full font-bold hover:bg-blue-100 transition">Lihat Semua</a>
                </div>
                            ...
                            <?php if(mysqli_num_rows($q_terbaru) > 0): ?>
                                ...
                                <tr class="hover:bg-blue-50/50 transition">
                                    ...
                                    <td class="px-6 py-4 text-gray-600">
                                        <span class="bg-gray-100 px-2 py-1 rounded text-xs font-semibold"><?= $row['jurusan_pilihan'] ?></span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <?php elseif($row['status_pendaftaran'] == 'diterima'): ?>
                                            <span class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-[10px] font-bold uppercase tracking-wide">Lulus</span>
                                        <?php else: ?>
                                            <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-[10px] font-bold uppercase tracking-wide">Ditolak</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <a href="verifikasi.php" class="text-blue-600 hover:text-blue-800 font-semibold text-xs border border-blue-200 px-3 py-1 rounded hover:bg-blue-50 transition">
                                            Cek Detail &rarr;
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="px-6 py-10 text-center text-gray-400">
                                        ...
                                        <span class="italic">Belum ada data pendaftaran masuk.</span>
                                    </td>
                                </tr>
                            <?php endif; ?>
